const canvas = {"width":800,"height":600}; canvas.getContext = () => ({ arc:()=>{}, moveTo:()=>{}, lineTo:()=>{}, stroke:()=>{}, fill:()=>{}, beginPath:()=>{}, clearRect:()=>{}, save:()=>{}, restore:()=>{}, translate:()=>{}, scale:()=>{}, fillText:()=>{}, closePath:()=>{}, strokeText:()=>{} }); canvas.addEventListener = ()=>{}; canvas.getBoundingClientRect = () => ({left:0, top:0}); const ctx = canvas.getContext('2d');
        ...
        const zoomSlider = {addEventListener:()=>{}};
